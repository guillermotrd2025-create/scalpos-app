...
export async function createSession(data: {
  ...
  // Validación de horario restrictivo: solo de 07:00 a 11:00 (11:59)
  if (currentHour < 7 || currentHour >= 12) {
    throw new Error("⛔ OPERATIVA BLOQUEADA: Tu horario permitido es solo de 07:00 a 11:00. Sal del mercado.");
  }
