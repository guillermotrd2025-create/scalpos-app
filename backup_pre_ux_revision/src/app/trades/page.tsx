          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b text-xs" style={{ borderColor: "var(--border)", color: "var(--text-muted)" }}>
                {["Fecha","Hora","Dir","Setup","Entrada","SL","TP","R:R","PnL","Plan","Errores",""].map((h) => (
            ...
            <tbody>
              {trades.map((t: any) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 font-mono text-xs" style={{ color: "var(--red)" }}>
                    {t.sl_price ?? "—"}
                  </td>
                  <td className="px-4 py-3 font-mono text-xs" style={{ color: "var(--green)" }}>
                    {t.tp_price ?? "—"}
                  </td>
